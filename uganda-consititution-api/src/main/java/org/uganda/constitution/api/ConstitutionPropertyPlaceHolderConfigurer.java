package org.uganda.constitution.api;
 ...
 * 
 */
public class ConstitutionPropertyPlaceHolderConfigurer extends
		PropertyPlaceholderConfigurer {
    private String classPathPropertiesFilename = "CONSTITUTION_SETTINGS.properties";
    private String environmentVariable = "CONSTITUTION_SETTINGS";
	...
	if (systemVariable != null) {
	    ...
	    log.warn("Unable to find environment or system variable: "
					+ environVariable);
	}
     ...
     */
    public void setClassPathPropertiesFilename(
			String classPathPropertiesFilename) {
