...
public class AddOrEditObjectGroup extends javax.swing.JFrame {
    ...
    private ViewObjGroupChapterSchedule viewObjGroupChapterSchedule;
    private ObjectiveGroup objGroup;
    private ObjectiveGroupService objGroupService;

    /** Creates new form AddOrEditConstitution */
    public AddOrEditObjectGroup(ViewObjGroupChapterSchedule viewObjGroupChapterSchedule, ObjectiveGroup objGroup) {
        this.viewObjGroupChapterSchedule = viewObjGroupChapterSchedule;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        this.dispose();
        objGroup = null;
        viewObjGroupChapterSchedule.setVisible(true);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ObjectiveGroup newObjGroup;
            if (objGroup != null) {
                newObjGroup = objGroup;
            } else {
                newObjGroup = new ObjectiveGroup();
                newObjGroup.setConstitution(objGroup.getConstitution());
            }

            newObjGroup.setName(objNameTxtField.getText());

            if (ContentValidator.isInteger(objGroupNoTxtField.getText())) {
                newObjGroup.setObjGroupNumber(Integer.parseInt(objGroupNoTxtField.getText()));
            } else {
                MessageBox.showMessage("Supplied Group number not an integer", this, JOptionPane.ERROR_MESSAGE);
            }

            newObjGroup.setTextContent(objDataTxtArea.getText());

            objGroupService.validateObjectiveGroup(newObjGroup);
            objGroupService.save(newObjGroup);

            this.dispose();
            ViewObjGroupChapterSchedule vObjGroupChapterSchedule = new ViewObjGroupChapterSchedule(viewObjGroupChapterSchedule.getUgConstitution(), objGroup.getConstitution());
            vObjGroupChapterSchedule.setVisible(true);
            MessageBox.showMessage("ObjectiveGroup saved sucessfully.", vObjGroupChapterSchedule, JOptionPane.INFORMATION_MESSAGE);
